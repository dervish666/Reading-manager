  ...
  sorted.sort((a, b) => {
    ...
    switch (sortBy) {
      ...
      case "readingLevel":
        ...
        break;
      case "lastReadDate":
        aValue = a.lastReadDate ? new Date(a.lastReadDate) : /* @__PURE__ */ new Date(0);
        bValue = b.lastReadDate ? new Date(b.lastReadDate) : /* @__PURE__ */ new Date(0);
        break;
      default:
        return 0;
    }
...
__name(sortStudents, "sortStudents");
...
__name(sortSessions, "sortSessions");
...
// .wrangler/tmp/bundle-k97dtl/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-k97dtl/middleware-loader.entry.ts
